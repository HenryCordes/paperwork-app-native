// src/__tests__/hooks/receipt-parsing/praxisStoreReceipt.test.ts
...
import { mockTextElements } from "../../mockData/praxisReceiptMockData";
...
/**
 * Test case for the Praxis receipt
 */
describe("Praxis Receipt Tests", () => {
  const expectedTotal = 14.14;
  const expectedTaxLow = 0;
  const expectedTaxHigh = 2.45;
  const expectedDay = 9;
