// src/__tests__/hooks/receipt-parsing/kruidvatReceipt.test.ts
...
import { mockTextElements } from "../../mockData/kruidvatReceiptMockData";
...
/**
 * Test case for the [Kruidvat] receipt
 */
describe("[Kruidvat] Receipt Tests", () => {
  const expectedTotal = 18.98;
  const expectedTaxLow = 0;
  const expectedTaxHigh = 3.29;
