...
import { mockTextElements } from "../../mockData/primeraReceiptMockData";
...
/**
 * Test case for the [Primera] receipt
 */
describe("[Primera] Receipt Tests", () => {
  const expectedTotal = 12.5;
  const expectedTaxLow = 0;
  const expectedTaxHigh = 2.17;
