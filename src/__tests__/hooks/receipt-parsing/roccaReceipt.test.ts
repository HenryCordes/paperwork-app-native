// src/__tests__/hooks/receipt-parsing/roccaReceipt.test.ts
...
import { mockTextElements } from "../../mockData/roccaReceiptMockData";
...
/**
 * Test case for the [Rocca] receipt
 */
describe("[Rocca] Receipt Tests", () => {
  const expectedTotal = 33.1;
  const expectedTaxLow = 2.28;
  const expectedTaxHigh = 0.95;
